...
VL_ATTR_COLD void Vfulladder4_tb___024unit___ctor_var_reset(Vfulladder4_tb___024unit* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vfulladder4_tb__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vfulladder4_tb___024unit___ctor_var_reset\n"); );
    // Body
